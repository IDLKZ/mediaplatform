            ...
            <section class="boxs">
                ...
                <div class="boxs-body">
                    <form id="my-form" action="{{route("teacher.checkResult")}}" method="post" enctype="multipart/form-data" class="form-horizontal" name="form4" role="form" id="form4" data-parsley-validate>
                        ...
                        <div class="boxs-header">
                            <h3 class="custom-font hb-blush">
                                <strong>{{__("admin.rating")}}</strong></h3>
                        </div>
                        <hr class="line-dashed full-witdh-line" />
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{{__("admin.rating")}} </label>
                            <div class="col-sm-9">
                                <input name="result" value="{{$result->result}}" type="number" min="0" max="10" class="form-control" placeholder="{{__("admin.rating")}}" data-parsley-trigger="change" required>
                            </div>
                        </div>
                        <div class="form-group">
