                                ...
                                <ul class="inbox-widget list-unstyled clearfix">
                                    <li class="inbox-inner"> <a href="#">
                                            <div class="inbox-item">
                                                ...
                                                <div class="inbox-item-info">
                                                    <p class="author">{{$str = $result->status == 1 ? __("admin.passed") : ($result->status == 0 ? __("admin.unchecked") : __("admin.recheck"))}}</p>
                                    ...
                                    <li class="inbox-inner"> <a href="#">
                                            <div class="inbox-item">
                                                ...
                                                <div class="inbox-item-info">
                                                    ...
                                                    <p class="inbox-message">{{__("admin.user.subscriber")}}</p>
                                                </div>
                                            </div>
                                        </a> </li>
                                    <li class="inbox-inner"> <a href="#">
                                    ...
                                    <li class="inbox-inner"> <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-img"><i style="font-size: 40px" class="fa fa-clock-o"></i> </div>
                                                <div class="inbox-item-info">
                                                    <p class="author">{{$str = $result->checked_day != null ? \Carbon\Carbon::parse($result->checked_day)->diffForHumans() : __("admin.unchecked")}}</p>
