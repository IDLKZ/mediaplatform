            ...
            <section class="boxs">
                <div class="boxs-header">
                    <h3 class="custom-font hb-blush">
                        <strong>{{__("admin.news_review_questions")}}</strong></h3>
                </div>
                @if ($errors->any())
                ...
                @endif
                <div class="boxs-body">
                    <form id="my-form" action="{{route("review-question.store")}}" method="post" enctype="multipart/form-data"  class="form-horizontal" name="form4" role="form" id="form4" data-parsley-validate>
                        @csrf
