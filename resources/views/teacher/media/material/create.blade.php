            ...
            <section class="boxs">
                <div class="boxs-header">
                    <h3 class="custom-font hb-blush">
                        <strong>{{__('admin.header.new_material')}}</strong></h3>
                </div>
                @if ($errors->any())
                ...
                <div class="boxs-body">
                    <form id="my-form" action="{{route("material.store")}}" method="post" enctype="multipart/form-data" class="form-horizontal" name="form4" role="form" id="form4" data-parsley-validate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="title" type="text" class="form-control" placeholder="{{__('admin.filename')}}" maxlength="255" data-parsley-trigger="change" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="customFile">
                                    <span class="selectedFile">{{__('admin.file')}}</span>
