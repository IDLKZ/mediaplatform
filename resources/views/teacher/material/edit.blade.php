            ...
            <section class="boxs">
                <div class="boxs-header">
                    <h3 class="custom-font hb-blush">
                        <strong>ИЗМЕНИТЬ</strong> МАТЕРИАЛ К ВИДЕО</h3>
                </div>
                @if ($errors->any())
                ...
                <div class="boxs-body">
                    <form id="my-form" action="{{route("material.update",$material->id)}}" method="post"  enctype="multipart/form-data" class="form-horizontal" name="form4" role="form" id="form4" data-parsley-validate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="title" type="text" class="form-control" placeholder="Наименование файла" maxlength="255" data-parsley-trigger="change" required value="{{$material->title}}">
                            </div>
                        </div>
