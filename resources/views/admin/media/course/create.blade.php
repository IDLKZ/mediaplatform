                ...
                <div class="boxs-body">
                    ...
                    <form id="my-form" action="{{route("admin-course.store")}}" method="post" enctype="multipart/form-data" class="form-horizontal" name="form4" role="form" id="form4" data-parsley-validate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="requirement" type="text" class="form-control" placeholder="{{__("admin.course_requirement")}}" maxlength="500" data-parsley-trigger="change" required>
                            </div>
                        </div>
                        <hr class="line-dashed full-witdh-line" />
                        <div class="form-group">
                        ...
                        <div class="boxs-footer text-right bg-tr-black lter dvd dvd-top">
                            ...
                            <a href="{{route("admin-course.index")}}" class="btn btn-raised btn-primary">{{__("admin.back")}}</a>
                        </div>
                    </form>
                </div>
