...
@section('content')
    <a href="{{route("admin-category.index")}}" class="btn btn-raised btn-info">{{__('content.back')}}</a>
    <!-- bradcome -->
    <div class="row">
        <div class="col-md-12">
            <section class="boxs">
                ...
                @endif
                <div class="boxs-body">
                    <form id="my-form" action="{{route("admin-category.store")}}" method="post" enctype="multipart/form-data" class="form-horizontal" name="form4" role="form" id="form4" data-parsley-validate>
                        @csrf
