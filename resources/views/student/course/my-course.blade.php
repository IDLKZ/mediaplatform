        ...
        <div class="p-4">
            @foreach($courses as $course)
                <div class="card text-left mb-3">
                    <div class="card-body">
                        <div class="c100 p{{$course->course->videos->count() != 0 ? intval((count($course->course->results)/$course->course->videos->count())*100) : 0}} green small">
                            <span>{{$course->course->videos->count() != 0 ? intval((count($course->course->results)/$course->course->videos->count())*100) : 0}}%</span>
                            <div class="slice">
                                <div class="bar"></div>
                                <div class="fill"></div>
                            </div>
