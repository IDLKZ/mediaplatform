...
{{--            <a href=""><li class="list-group-item"><i class="far fa-bell mr-4"></i>Уведомления</li></a>--}}
            ...
            <a href="{{route('forums')}}"><li class="list-group-item"><i class="far fa-comments mr-4"></i>{{__('student.my_discuss')}}</li></a>
            <a href="{{route('myCertificates')}}"><li class="list-group-item"><i class="fas fa-award mr-4"></i>{{__('student.my_certificate')}}</li></a>
            <a href="{{route('userProfileSettings')}}"><li class="list-group-item"><i class="fas fa-cog mr-4"></i>{{__('student.my_settings')}}</li></a>
        </ul>
    </div>
</aside>
...
<div class="desk-none">
    ...
    <div class="card">
        <div class="card-body">
            <div class="menu-btn">&#9776; {{__('student.my_menu')}}</div>
        </div>
    </div>
    ...
    <nav class="pushy pushy-left" data-focus="#target">
        ...
        <ul>
            <a href="{{route('userProfile')}}"><li><i class="far fa-user mr-4"></i>{{__('student.my_profile')}}</li></a>
            <a href="{{route('listCourses')}}"><li><i class="fa fa-video-camera mr-4"></i>{{__('student.all_courses')}}</li></a>
            <a href="{{route('student.course')}}"><li><i class="fas fa-photo-video mr-4"></i>{{__('student.my_courses')}}</li></a>
            {{--            <a href=""><li class="list-group-item"><i class="far fa-bell mr-4"></i>Уведомления</li></a>--}}
